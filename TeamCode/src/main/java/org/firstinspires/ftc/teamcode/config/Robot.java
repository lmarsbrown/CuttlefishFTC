...
public class Robot{
    public FTCMotor leftBackMotor  ;
    public FTCMotor rightBackMotor ;
    public FTCMotor rightFrontMotor;
    public FTCMotor leftFrontMotor ;
    ...
    {
        leftBackMotor   = new FTCMotor(hardwareMap.get(DcMotor.class,config.leftBackMotorName  ));
        rightBackMotor  = new FTCMotor(hardwareMap.get(DcMotor.class,config.rightBackMotorName ));
        rightFrontMotor = new FTCMotor(hardwareMap.get(DcMotor.class,config.rightFrontMotorName));
        leftFrontMotor  = new FTCMotor(hardwareMap.get(DcMotor.class,config.leftFrontMotorName ));
